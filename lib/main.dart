    ...
    return Consumer<LanguageProvider>(
      builder: (context, languageProvider, child) {
        return MaterialApp(
          ...
          locale: languageProvider.currentLocale, // Usa o idioma selecionado
          ...
          localeResolutionCallback: (locale, supportedLocales) {
            ...
            return supportedLocales.first; // Retorna Português como padrão
          },
          ...
          routes: {
            ...
            '/birthday-reservation': (context) =>
                const BirthdayReservationScreen(),
          },
            ...
            switch (settings.name) {
              ...
              case '/event-booked':
                ...
                if (reservaId != null) {
                  return MaterialPageRoute(
                    builder: (context) =>
                        EventBookedScreen(reservaId: reservaId),
                  );
                }
                return MaterialPageRoute(
                  builder: (context) => const Scaffold(
              ...
              case '/verification':
                ...
                return MaterialPageRoute(
                  builder: (context) => const Scaffold(
                    body: Center(
                        child:
                            Text('Erro: Dados de verificação não fornecidos.')),
                  ),
                );
